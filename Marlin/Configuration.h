...
#define STRING_CONFIG_H_AUTHOR "(nmaupu, CR-10 V2)" // Who made the changes.
...
#define Z_AXIS_HEIGHT 400 // Height is 400 mm

// Travel limits (mm) after homing, corresponding to endstop positions.
#define X_MIN_POS 0
#define Y_MIN_POS 0
#define Z_MIN_POS 0
#define X_MAX_POS (X_BED_SIZE+23) // 15mm Extra space on the right end
#define Y_MAX_POS (Y_BED_SIZE+8)  // 4mm Extra space behind the bed
#define Z_MAX_POS (Z_AXIS_HEIGHT)
